...
run-executor: 
	TEMPLATEEXECUTOR_PORT=8083 go run cmd/template-executor/main.go
...
docker-build-executor: 
	go mod vendor
	docker build --build-arg TOKEN=$(GITHUB_TOKEN) -t template-executor -f build/template-executor/Dockerfile .
